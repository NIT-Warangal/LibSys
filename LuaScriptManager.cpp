...
#ifdef _WIN32
	if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)ScriptTable) == 0) {
...
#ifdef _WIN32
    if(ScriptTable == NULL) {
        ScriptTable = (Script **)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE | HEAP_ZERO_MEMORY, (ui8ScriptCount+1)*sizeof(Script *));
    } else {
		ScriptTable = (Script **)HeapReAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)oldbuf, (ui8ScriptCount+1)*sizeof(Script *));
    }
#else
