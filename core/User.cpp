...
UserBan::~UserBan() {
#ifdef _WIN32
    if(sMessage != NULL && HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sMessage) == 0) {
...
#ifdef _WIN32
    pUserBan->sMessage = (char *)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, iMessLen+1);
#else
...
#ifdef _WIN32
    if(pBuffer != NULL) {
        if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)pBuffer) == 0) {
...
User::~User() {
...
#ifdef _WIN32
	if(sLastChat != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sLastChat) == 0) {
...
#ifdef _WIN32
	if(sLastPM != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sLastPM) == 0) {
...
#ifdef _WIN32
	if(sLastSearch != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sLastSearch) == 0) {
	...
	if(sMyInfoShort != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sMyInfoShort) == 0) {
...
#ifdef _WIN32
	if(sMyInfoLong != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sMyInfoLong) == 0) {
	...
	if(sMyInfoOriginal != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sMyInfoOriginal) == 0) {
...
#ifdef _WIN32
	if(sVersion != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sVersion) == 0) {
	...
	if(sChangedDescriptionShort != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sChangedDescriptionShort) == 0) {
	...
	if(sChangedDescriptionLong != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sChangedDescriptionLong) == 0) {
	...
	if(sChangedTagShort != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sChangedTagShort) == 0) {
	...
	if(sChangedTagLong != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sChangedTagLong) == 0) {
	...
	if(sChangedConnectionShort != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sChangedConnectionShort) == 0) {
	...
	if(sChangedConnectionLong != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sChangedConnectionLong) == 0) {
	...
	if(sChangedEmailShort != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sChangedEmailShort) == 0) {
	...
	if(sChangedEmailLong != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sChangedEmailLong) == 0) {
...
#ifdef _WIN32
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sNick) == 0) {
...
#ifdef _WIN32
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)cur->sCommand) == 0) {
...
#ifdef _WIN32
        if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)curto->sCommand) == 0) {
...
#ifdef _WIN32
        if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)curto->ToNick) == 0) {
...
bool User::MakeLock() {
	...
	#ifdef _BUILD_GUI
	    #ifndef _M_X64
	        static const char * sLock = "$Lock EXTENDEDPROTOCOL                           win Pk=Lib|"; // 63
	    #else
	        static const char * sLock = "$Lock EXTENDEDPROTOCOL                           wg6 Pk=Lib|"; // 63
	    #endif
	#else
	    #ifndef _M_X64
	        static const char * sLock = "$Lock EXTENDEDPROTOCOL                           wis Pk=Lib|"; // 63
	    #else
	        static const char * sLock = "$Lock EXTENDEDPROTOCOL                           ws6 Pk=Lib|"; // 63
	    #endif
	#endif
#else
	static const char * sLock = "$Lock EXTENDEDPROTOCOL                           nix Pk=Lib|"; // 63
#endif
...
#ifdef _WIN32
    uLogInOut->pBuffer = (char *)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, 64);
#else
...
#ifdef _WIN32
    sNick = (char *)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, ui8NewNickLen+1);
#else
...
void User::SetMyInfoOriginal(char * sNewMyInfo, const uint16_t &ui16NewMyInfoLen) {
...
#ifdef _WIN32
    sMyInfoOriginal = (char *)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, ui16NewMyInfoLen+1);
#else
    ...
    if(sOldMyInfo != NULL) {
#ifdef _WIN32
        if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sOldMyInfo) == 0) {
...
#ifdef _WIN32
        if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)u->sMyInfoLong) == 0) {
...
#ifdef _WIN32
    u->sMyInfoLong = (char *)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, ui16NewMyInfoLongLen+1);
#else
...
#ifdef _WIN32    	    
    	if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)u->sMyInfoShort) == 0) {
...
#ifdef _WIN32
    u->sMyInfoShort = (char *)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, ui16NewMyInfoShortLen+1);
#else
...
#ifdef _WIN32
    sVersion = (char *)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, szLen+1);
#else
...
#ifdef _WIN32
    sLastChat = (char *)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, szLen+1);
#else
...
#ifdef _WIN32
    sLastPM = (char *)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, szLen+1);
#else
...
#ifdef _WIN32
    sLastSearch = (char *)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, szLen+1);
#else
...
#ifdef _WIN32
		if(uLogInOut->pBuffer == NULL) {
			uLogInOut->pBuffer = (char *)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, szLen+1);
		} else {
			uLogInOut->pBuffer = (char *)HeapReAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, pOldBuf, szLen+1);
		}
#else
...
#ifdef _WIN32
		if(uLogInOut->pBuffer == NULL) {
			uLogInOut->pBuffer = (char *)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, 512);
		} else {
			uLogInOut->pBuffer = (char *)HeapReAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, pOldBuf, 512);
		}
#else
...
void User::FreeBuffer() {
    if(uLogInOut->pBuffer != NULL) {
#ifdef _WIN32
        if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)uLogInOut->pBuffer) == 0) {
...
#ifdef _WIN32
                    clsUsers::mPtr->nickList = (char *)HeapReAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)pOldBuf, clsUsers::mPtr->nickListSize+NICKLISTSIZE+1);
#else
...
#ifdef _WIN32
                clsUsers::mPtr->opList = (char *)HeapReAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)pOldBuf, clsUsers::mPtr->opListSize+OPLISTSIZE+1);
#else
...
void User::FreeInfo(char * sInfo, const char * sName) {
	if(sInfo != NULL) {
		if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)sInfo) == 0) {
...
#ifdef _WIN32
                cur->sCommand = (char *)HeapReAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)pOldBuf, cur->iLen+szCommandLen+1);
#else
...
#ifdef _WIN32
        pNewcmd->sCommand = (char *)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, szCommandLen+1);
#else
...
#ifdef _WIN32
        pNewcmd->ToNick = (char *)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, to->ui8NickLen+1);
#else
...
char * User::SetUserInfo(char * sOldData, uint8_t &ui8OldDataLen, char * sNewData, size_t &sz8NewDataLen, const char * sDataName) {
    ...
    if(sz8NewDataLen > 0) {
#ifdef _WIN32
        sOldData = (char *)HeapAlloc(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, sz8NewDataLen+1);
#else
...
#ifdef _WIN32
    if(HeapFree(clsServerManager::hLibHeap, HEAP_NO_SERIALIZE, (void *)pCommand->sCommand) == 0) {
