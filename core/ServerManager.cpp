...
//---------------------------------------------------------------------------
	...
	HANDLE clsServerManager::hConsole = NULL, clsServerManager::hLuaHeap = NULL, clsServerManager::hLibHeap = NULL, clsServerManager::hRecvHeap = NULL, clsServerManager::hSendHeap = NULL;
...
void clsServerManager::Initialize() {
    ...
    hLibHeap = HeapCreate(HEAP_NO_SERIALIZE, 0x100000, 0);
